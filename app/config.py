...
# [ADVANCED]
ROUTING = parser["ADVANCED"]["ROUTING"]
CALIBRATIONMODE = parser["ADVANCED"]["CALIBRATIONMODE"]
DYNAMIC_SPACING = parser["ADVANCED"]["DYNAMIC_SPACING"]
TWIST_NORMALIZED = bool(int(parser["ADVANCED"]["TWIST_NORMALIZED"]))
SEEDLEN = int(parser["ADVANCED"]["SEEDLEN"])
SEED_BORROW_LIMIT = int(parser["ADVANCED"]["SEED_BORROW_LIMIT"])
